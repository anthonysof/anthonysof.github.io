...
const bootSequence = [
    ...
    { type: 'skill', name: 'Python', comment: 'Python is my duct tape for when C++ is overkill. Which is always.' },
    ...
    { type: 'skill', name: 'Cursor', comment: 'Cursor is my tool. I do the thinking. It does the typing.' },
